...
export default function Home({ posts = [], loading = false }) {

  const list = Array.isArray(posts) ? posts : [];

  const featured = list[0];
  const secondary = list.slice(1, 4);
  const latest = list.slice(4, 10);
  ...
  return (
    <div className="page">
      <section className="hero">
        ...
        <p>Carregando crônicas…</p>
        <p>
          Crônicas sobre o que me move: do Maracanã à sala de aula, do código à
          arquibancada, do noticiário ao gato em cima do teclado.
        </p>
      </section>

      {/* GRID PRINCIPAL: esquerda conteúdo / direita widgets */}
      <section className="homeGrid">
        <div className="homeLeft">
          ...
          {/* últimas crônicas SOBEM pra preencher o “vazio” da esquerda */}
          

          {/* temas vêm depois (não serão empurrados pelos widgets) */}
          <section className="themes">
            ...
            <div className="topicsGrid">
              <div
                className="topicCard topicFutebol"
                style={{ "--topic-bg": `url("${import.meta.env.BASE_URL}images/topics/futebol.jpg")` }}
              >
              ...
              <div
                className="topicCard topicEsportes"
                style={{ "--topic-bg": `url("${import.meta.env.BASE_URL}images/topics/esportes.jpg")` }}
              >
              ...
              <div
                className="topicCard topicCotidiano"
                style={{ "--topic-bg": `url("${import.meta.env.BASE_URL}images/topics/cotidiano.jpg")` }}
              >
                <div className="topicTitle">Cotidiano</div>
                <div className="topicSub">O dia a dia que insiste em virar crônica.</div>
                <div className="chipRow">
                  <Link className="chip" to="/tema/namoro">Namoro/Tinder</Link>
                  <Link className="chip" to="/tema/astrologia">Astrologia</Link>
              ...
              <div
                className="topicCard topicCultura"
                style={{ "--topic-bg": `url("${import.meta.env.BASE_URL}images/topics/cultura.jpg")` }}
              >
              ...
              <div
                className="topicCard topicPolitica"
                style={{ "--topic-bg": `url("${import.meta.env.BASE_URL}images/topics/politica.jpg")` }}
              >
              ...
              <div
                className="topicCard topicGestao"
                style={{ "--topic-bg": `url("${import.meta.env.BASE_URL}images/topics/gestao.jpg")` }}
              >
          ...
          <section className="latest latestInline">
        ...
        {/* widgets ficam em coluna fixa à direita */}
        <aside className="homeRight">
          <WeatherWidget />
          <HoroscopeWidget />
          <AgendaWidget />
          <BrasileiraoWidget compact />
